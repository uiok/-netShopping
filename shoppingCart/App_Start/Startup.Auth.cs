...
namespace shoppingCart
{
    public partial class Startup
    {
        ...
        public void ConfigureAuth(IAppBuilder app)
        {
            ...
            //以下是改寫過的版本
            app.CreatePerOwinContext<SecureAuthUserManager>(SecureAuthUserManager.Create);
            app.CreatePerOwinContext<SecureAuthUserSingInManager>(SecureAuthUserSingInManager.Create);
                ...
                new CookieAuthenticationOptions
                {
                    ...
                    Provider = new CookieAuthenticationProvider
                    {
                        OnApplyRedirect = context =>
                        {
                            ...
                            //非必要
                            context.Response.Cookies.Delete("自定義cookieName", options);
                            context.Response.Cookies.Delete("自定義cookieName", options);
